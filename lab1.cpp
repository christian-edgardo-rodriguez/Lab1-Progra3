...
double area(double diagonal, double altura1,double altura2);
...
int main(int argc,char*argv[]){
	...
	if(opc==1){
		...
		cout<<"Semiperimetro triangulo 2: "<<semiperimetro(lado4,lado5,lado3)<<endl;
		cout<<"Perimetro triangulo 1: "<<perimetro(lado1,lado2,lado3)<<endl;
		cout<<"Perimetro triangulo 2: "<<perimetro(lado4,lado5,lado3)<<endl;
		cout<<endl;
		double semiperimetro1=semiperimetro(lado1,lado2,lado3);
		double semiperimetro2=semiperimetro(lado4,lado5,lado3);
		...
		double altura1=altura(lado3,lado2,lado1,semiperimetro1);
		double altura2=altura(lado3,lado2,lado1,semiperimetro2);
		cout<<endl;
		cout<<"El area del trapezoide es: "<<area(lado3,altura1,altura2)<<endl;
	}
	return 0;
...
double altura(double lado1,double lado2, double lado3, double semiperimetro){
	double altura=(2.0/lado1)*sqrt(semiperimetro*(semiperimetro-lado1)*(semiperimetro-lado2)*(semiperimetro-lado3));
	return altura;
}
double area(double diagonal, double altura1,double altura2){
	double area=((diagonal*altura1)/2.0)+((diagonal*altura2)/2.0);
	return area;
}
